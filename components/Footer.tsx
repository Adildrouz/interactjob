      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-1 text-sm text-gray-500 italic">Trouvez l&apos;emploi de vos rêves</p>
            <p className="mt-4 text-sm leading-relaxed">
              La plateforme d&apos;emploi dédiée au marché marocain. Rejoignez plus de
              18 000 professionnels qui nous font confiance chaque jour.
            </p>
            <a
            ...
            >
              ...
              Suivre InteractJob sur LinkedIn
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li><Link href="/offres" className="hover:text-white transition-colors">Offres d&apos;emploi</Link></li>
              <li><Link href="/blog" className="hover:text-white transition-colors">Blog RH</Link></li>
              <li><Link href="/publier" className="hover:text-white transition-colors">Publier une offre</Link></li>
        ...
        <div className="mt-10 pt-8 border-t border-gray-800 flex flex-col sm:flex-row justify-between items-center gap-4 text-sm">
          <p className="text-gray-500">© {new Date().getFullYear()} InteractJob. Tous droits réservés.</p>
