...
const MOROCCAN_CITIES = [
  'Casablanca', 'Rabat', 'Marrakech', 'F�s', 'Agadir', 'Tanger',
  'Mekn�s', 'Oujda', 'T�touan', 'Khouribga', 'Essaouira', 'Safi',
  'El Jadida', 'B�ni Mellal', 'Nador', 'Settat', 'La�youne',
];
...
function normalizeItem(item, feed) {
  ...
  if (!link) return null; // Skip items with no URL — can't deduplicate them
